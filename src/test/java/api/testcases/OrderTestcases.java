...
/**
 * OrderTestcases - Comprehensive test scenarios for Order module
 * Covers positive, negative, and data-driven test cases for order CRUD operations,
 * status management, payment, and invoice generation
 */
public class OrderTestcases extends BaseTest {
    ...
    public void createOrderWithMissingShopperIdTest() {
        ...
        String shopperId = "";  // Empty shopper ID
        OrderPayload payload = new OrderPayload();
        payload.setTotalAmount(999.99);
        payload.setPaymentMethod("CREDIT_CARD");
    ...
    public void createOrderWithNegativeAmountTest() {
        ...
        OrderPayload payload = new OrderPayload();
        payload.setShopperId(shopperId);
        payload.setTotalAmount(-999.99);  // Invalid negative amount
        payload.setPaymentMethod("CREDIT_CARD");
