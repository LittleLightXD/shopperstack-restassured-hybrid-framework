...
/**
 * ReviewTestcases - Comprehensive test scenarios for Review module
 * Covers positive, negative, and data-driven test cases for product reviews,
 * ratings, helpful votes, and review management
 */
public class ReviewTestcases extends BaseTest {
    ...
    public void createReviewWithInvalidRatingTest() {
        ...
        payload.setProductId("product-123456");
        payload.setShopperId("shopper-123456");
        payload.setRating(10);  // Invalid rating (max is 5)
    ...
    public void createReviewWithEmptyCommentTest() {
        ...
        payload.setShopperId("shopper-123456");
        payload.setRating(5);
        payload.setComment("");  // Empty comment
    ...
    public void createReviewWithNegativeRatingTest() {
        ...
        payload.setProductId("product-123456");
        payload.setShopperId("shopper-123456");
        payload.setRating(-1);  // Invalid negative rating
